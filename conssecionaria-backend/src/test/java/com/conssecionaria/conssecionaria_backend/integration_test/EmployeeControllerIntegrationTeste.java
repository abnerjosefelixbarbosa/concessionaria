...
class EmployeeControllerIntegrationTeste {
	...
	void shouldFindEmployeeByIdAndReturn200Status() throws Exception {
		...
		mockMvc.perform(get("/employees/find-employee-by-id/" + employees.get(0).getId()).contentType(MediaType.APPLICATION_JSON)
	...
	void shouldListEmployeesByNameOrEmployeeStatusOrEmployeeTypeAndReturn200Status() throws Exception {
		...
		Employee employee2 = new Employee(null, "name2", "2222222222",
				"email2@gmail.com", "81922222222", LocalDate.now().withYear(1991), "43468998465", new BigDecimal("2500.00"),
				null, EmployeeStatus.ACTIVE, EmployeeType.MANAGER, null);
		
		Employee employee3 = new Employee(null, "name3", "3333333333",
				"email3@gmail.com", "81933333333", LocalDate.now().withYear(1991), "27406772432", new BigDecimal("2000.00"),
				null, EmployeeStatus.ACTIVE, EmployeeType.ASSISTANT_MANAGER, null);
		
		Employee employee4 = new Employee(null, "name4", "4444444444",
				"email4@gmail.com", "81944444444", LocalDate.now().withYear(1991), "66134259403", new BigDecimal("1500.00"),
				100, EmployeeStatus.ACTIVE, EmployeeType.SALLER, null);
