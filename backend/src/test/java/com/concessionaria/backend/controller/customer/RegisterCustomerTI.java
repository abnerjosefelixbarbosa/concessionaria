...
class RegisterCustomerTI {
	...
	void registerCustomerTest1() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "26516743460", "email1@gmail.com", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest2() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO(null, "26516743460", "email1@gmail.com", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest3() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("", "26516743460", "email1@gmail.com", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest4() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO(
				...
				"26516743460", "email1@gmail.com", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest6() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", null, "email1@gmail.com", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest7() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "", "email1@gmail.com", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest8() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "26516743461", "email1@gmail.com", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest9() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "31729421000180", "email1@gmail.com", "81911111111", CustomerType.PJ);
	...
	void registerCustomerTest11() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "26516743460", null, "81911111111", CustomerType.PF);
	...
	void registerCustomerTest12() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "26516743460", "", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest13() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "26516743460", "email1gmail.com", "81911111111", CustomerType.PF);
	...
	void registerCustomerTest15() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "26516743460", "email1@gmail.com", null, CustomerType.PF);
	...
	void registerCustomerTest16() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "26516743460", "email1@gmail.com", "", CustomerType.PF);
	...
	void registerCustomerTest17() throws Exception {
		CustomerRequestDTO dto = new CustomerRequestDTO("nome1", "26516743460", "email1@gmail.com",
				"8191111111111111111111111111111", CustomerType.PF);
	...
	@Test
	@DisplayName("Should not register customer when customer type is null and return status 400.")
	void registerCustomerTest19() throws Exception {
